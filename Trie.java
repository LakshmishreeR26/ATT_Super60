...
public class Trie {
    ...
    static boolean searchNode(TrieNode root, String word) {
        TrieNode curr = root;
        for (char c : word.toCharArray()) {
            if (curr.children[c - 'a'] == null) {
        ...
        //return curr.wordEnd == true; bad practise
        return curr.wordEnd;
    }

    public static void main(String[] args) {
        TrieNode root = new TrieNode();
        List<String> inputWords = Arrays.asList("ananya", "yathin", "dhriti", "kamal", "vishakh");
        for (String word : inputWords) {
            insertNode(root, word);
        }
        List<String> searchWords = Arrays.asList("ananya", "yathin", "dhriti", "kamal", "vishakh", "saurav", "ashank", "rahul");
